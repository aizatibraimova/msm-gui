class DirectorsController < ApplicationController
  ...
  def update
    ...
    #Overwrite each column with the updated values
  ...
  def create
    ...
    # Parameters: {"the_title"=>"1", "the_year"=>"2", "the_duration"=>"3", "the_description"=>"4", "image"=>"5", "teh_director_id"=>"6"}
    ...
    #Create a record in the moveie table
  end
